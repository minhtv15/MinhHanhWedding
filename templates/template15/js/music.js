...
window.onload = (event) => {
  setTimeout(function () {
    if (biicore.effect.type == "heart") {
      ...
      snowFallUser.snow(document.getElementsByTagName("body")[0], {
        round: true,
        shadow: true,
...
if (biicore.bgMusic) {
  ...
  document.write(`
	...
	<div class="bii-player">
		<div onclick="playPause();" class="bii-player-secondary"><div class="bii-player-secondary-content">Click vào đây nếu bạn muốn tắt nhạc!</div></div>
