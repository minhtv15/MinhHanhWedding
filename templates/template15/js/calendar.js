...
const i18nStrings = {
  ...
  de: {
    ...
    "modal.webview.ical.steps":
      "<ol><li><strong>Ă–ffne einen anderen Browser</strong> auf deinem Smartphone, ...</li><li>Nutze die <strong>EinfĂ¼gen</strong>-Funktion, um fortzufahren.</li></ol>",
    "modal.crios.ical.h": "Ă–ffne Safari",
    "modal.crios.ical.text":
      "Leider Chrome unter iOS Probleme mit der Art, wie wir Kalender-Dateien erzeugen.",
    "modal.crios.ical.steps":
      "<ol><li><strong>Ă–ffne Safari</strong>, ...</li><li>Nutze die <strong>EinfĂ¼gen</strong>-Funktion, um fortzufahren.</li></ol>",
    "modal.multidate.h": "Dies is eine Termin-Reihe",
    "modal.multidate.text":
      "FĂ¼ge die einzelnen Termine der Reihe nach deinem Kalender hinzu:",
    Event: "Termin",
    ...
    "modal.subscribe.yahoo.text":
      '<ol><li>Ă–ffne den Yahoo Kalender.</li><li>Klicke auf den "Aktionen" Tab.</li><li>WĂ¤hle "Weiteren Kalendern folgen".</li><li>WĂ¤hle einen Namen und fĂ¼ge die URL aus deiner Zwischenablage in das URL-Feld ein.</li></ol>',
    Cancel: "Abbrechen",
  },
  es: {
    ...
    "modal.clipboard.text":
      "Hemos copiado automĂ¡ticamente una URL mĂ¡gica en su portapapeles.",
    "modal.webview.ical.steps":
      "<ol><li><strong>Abre otro browser</strong> en tu smartphone, ...</li><li>Utilice la funciĂ³n de <strong>pegar</strong> para continuar.</li></ol>",
    ...
    "modal.crios.ical.steps":
      "<ol><li><strong>Abrir Safari</strong>, ...</li><li>Utilice la funciĂ³n de <strong>pegar</strong> para continuar.</li></ol>",
    "modal.multidate.h": "Esta es una serie de fechas",
    "modal.multidate.text":
      "AĂ±ada las fechas individuales a su calendario en orden:",
    Event: "TĂ©rmino",
    ...
    "modal.subscribe.yahoo.text":
      '<ol><li>Abra el calendario de Yahoo.</li><li>Haga clic en la pestaĂ±a "Acciones".</li><li>Seleccione "Seguir otros calendarios".</li><li>Elige un nombre y pega la URL de tu portapapeles en el campo URL.</li></ol>',
    Cancel: "Cancelar",
  },
  pt: {
    ...
    "modal.webview.ical.text":
      "Infelizmente, os navegadores em tampas tĂªm problemas com a forma como geramos o ficheiro de calendĂ¡rio.",
    "modal.clipboard.text":
      "CopiĂ¡mos automaticamente um URL mĂ¡gico para a sua Ă¡rea de transferĂªncia.",
    "modal.webview.ical.steps":
      "<ol><li><strong>Abrir outro browser</strong> en tu smartphone, ...</li><li>Use a funĂ§Ă£o <forte>colar</strong> para continuar.</li></ol>",
    "modal.crios.ical.h": "Safari aberto",
    "modal.crios.ical.text":
      "Infelizmente, o cromado no iOS tem problemas com a forma como geramos o ficheiro do calendĂ¡rio.",
    "modal.crios.ical.steps":
      "<ol><li><strong>Safari aberto</strong>, ...</li><li>Use a funĂ§Ă£o <forte>colar</strong> para continuar.</li></ol>",
    "modal.multidate.h": "Esta Ă© uma sĂ©rie de datas",
    "modal.multidate.text":
      "Adicione as datas individuais ao seu calendĂ¡rio, por ordem:",
    Event: "Termo",
    ...
    "modal.subscribe.yahoo.text":
      '<ol><li>Abrir o calendĂ¡rio do Yahoo.</li><li>Clique no separador "AcĂ§Ăµes".</li><li>Seleccione "Seguir outros calendĂ¡rios".</li><li>Escolha um nome e cole o URL da sua Ă¡rea de transferĂªncia no campo URL.</li></ol>',
    Cancel: "Cancelar",
  },
  fr: {
    ...
    "modal.webview.ical.text":
      "Malheureusement, les navigateurs in-app ont des problĂ¨mes avec la maniĂ¨re dont nous crĂ©ons les fichiers de agenda.",
    "modal.clipboard.text":
      "Nous avons automatiquement copiĂ© une URL magique dans ton presse-papiers.",
    "modal.webview.ical.steps":
      "<ol><li><strong>Ouvre un autre navigateur</strong> sur ton smartphone, ...</li><li>Utilise la fonction <strong>insĂ©rer</strong> pour continuer.</li></ol>",
    "modal.crios.ical.h": "Ouvre Safari",
    "modal.crios.ical.text":
      "Malheureusement, Chrome sur iOS a des problĂ¨mes avec la faĂ§on dont nous gĂ©nĂ©rons le fichier du agenda.",
    "modal.crios.ical.steps":
      "<ol><li><strong>Ouvre Safari</strong>, ...</li><li>Utilise la fonction <strong>insĂ©rer</strong> pour continuer.</li></ol>",
    "modal.multidate.h": "Il s'agit d'une sĂ©rie d'Ă©vĂ©nements",
    "modal.multidate.text":
      "Ajoute les diffĂ©rents rendez-vous dans l'ordre Ă  ton agenda:",
    Event: "Terminaison",
    ...
    "modal.subscribe.yahoo.text":
      '<ol><li>Ouvre le Yahoo calendar.</li><li>Clique sur l\'onglet "Actions".</li><li>SĂ©lectionne "Suivre d\'autres agendas".</li><li>Choisis un nom et colle l\'URL de ton presse-papiers dans le champ URL.</li></ol>',
    Cancel: "Annuler",
  },
  nl: {
  ...
  tr: {
    ...
    "modal.webview.ical.text":
      "Ne yazÄ±k ki, uygulama iĂ§i tarayÄ±cÄ±lar takvim dosyalarÄ±nÄ± oluÅŸturma ÅŸeklimizle ilgili sorunlar yaÅŸÄ±yor.",
    "modal.clipboard.text":
      "Panonuza otomatik olarak sihirli bir URL kopyaladÄ±k.",
    "modal.webview.ical.steps":
      "<ol><li><strong>AkÄ±llÄ± telefonunuzda baÅŸka bir tarayÄ±cÄ± aĂ§Ä±n</strong>, ...</li><li>Devam etmek iĂ§in <strong>insert</strong> fonksiyonunu kullanÄ±n.</li></ol>",
    "modal.crios.ical.h": "AĂ§Ä±k Safari",
    "modal.crios.ical.text":
      "Ne yazÄ±k ki iOS'ta Chrome'un takvim dosyasÄ± oluÅŸturma yĂ¶ntemiyle ilgili sorunlarÄ± var.",
    "modal.crios.ical.steps":
      "<ol><li><strong>AĂ§Ä±k Safari</strong>, ...</li><li>Devam etmek iĂ§in <strong>insert</strong> fonksiyonunu kullanÄ±n.</li></ol>",
    ...
    "modal.subscribe.yahoo.text":
      '<ol><li>Yahoo takvimini aĂ§Ä±n.</li><li>"Eylemler" sekmesine tÄ±klayÄ±n.</li><li>"DiÄŸer Takvimleri Takip Et" Ă¶ÄŸesini seĂ§in.</li><li>Bir ad seĂ§in ve URL\'yi panonuzdan URL alanÄ±na yapÄ±ÅŸtÄ±rÄ±n.</li></ol>',
    Cancel: "Ä°ptal",
  },
  zh: {
    ...
    "modal.webview.ical.text":
      "ä¸å¹¸ç„æ˜¯ï¼Œåº”ç”¨å†…æµè§ˆå™¨åœ¨æˆ‘ä»¬ç”Ÿæˆæ—¥å†æ–‡ä»¶ç„æ–¹å¼ä¸å­˜åœ¨é—®é¢˜ă€‚",
    "modal.clipboard.text": "æˆ‘ä»¬è‡ªå¨å°†é­”æœ¯ URL å¤åˆ¶åˆ°æ‚¨ç„å‰ªè´´æ¿ă€‚",
    "modal.webview.ical.steps":
      "<ol><li>æ‰“å¼€æ‰‹æœºä¸ç„ä»»ä½•å…¶ä»–æµè§ˆå™¨, ...</li><li>ç²˜è´´å‰ªè´´æ¿å†…å®¹å¹¶å¼€å§‹ă€‚</li></ol>",
    "modal.crios.ical.h": "æ‰“å¼€ Safari",
    "modal.crios.ical.text":
      "ä¸å¹¸ç„æ˜¯ï¼ŒiOS ä¸ç„ Chrome åœ¨æˆ‘ä»¬ç”Ÿæˆæ—¥å†æ–‡ä»¶ç„æ–¹å¼ä¸å­˜åœ¨é—®é¢˜ă€‚",
    "modal.crios.ical.steps":
      "<ol><li><strong>æ‰“å¼€ Safari</strong>, ...</li><li>ç²˜è´´å‰ªè´´æ¿å†…å®¹å¹¶å¼€å§‹ă€‚</li></ol>",
    ...
    "modal.subscribe.yahoo.text":
      "<ol><li>æ‰“å¼€ Yahoo æ—¥å†ă€‚</li><li>ç‚¹å‡»â€œæ“ä½œâ€æ ‡ç­¾ă€‚</li><li>é€‰æ‹©â€œå…³æ³¨å…¶ä»–æ—¥å†â€ă€‚</li><li>é€‰æ‹©ä¸€ä¸ªåç§°å¹¶å°†å‰ªè´´æ¿ä¸­ç„ URL ç²˜è´´åˆ° URL å­—æ®µä¸­ă€‚</li></ol>",
    Cancel: "ä¸­æ­¢",
  },
  ar: {
    ...
    "modal.webview.ical.text":
      "Ù„Ø³ÙˆØ¡ Ø§Ù„Ø­Ø¸ ØŒ ØªÙˆØ§Ø¬Ù‡ Ø§Ù„Ù…ØªØµÙØ­Ø§Øª Ø¯Ø§Ø®Ù„ Ø§Ù„ØªØ·Ø¨ÙÙ‚ Ù…Ø´Ø§ÙƒÙ„ ÙÙ Ø·Ø±ÙÙ‚Ø© Ø¥Ù†Ø´Ø§Ø¡ Ù…Ù„Ù Ø§Ù„ØªÙ‚ÙˆÙÙ….",
    "modal.clipboard.text":
      "Ù‚Ù…Ù†Ø§ ØªÙ„Ù‚Ø§Ø¦ÙÙ‹Ø§ Ø¨Ù†Ø³Ø® Ø¹Ù†ÙˆØ§Ù† URL Ø³Ø­Ø±Ù Ø¥Ù„Ù‰ Ø§Ù„Ø­Ø§ÙØ¸Ø© Ø§Ù„Ø®Ø§ØµØ© Ø¨Ùƒ.",
    "modal.webview.ical.steps":
      "<ol><li>Ø§ÙØªØ­ Ø£Ù Ù…ØªØµÙØ­ Ø¢Ø®Ø± Ø¹Ù„Ù‰ Ù‡Ø§ØªÙÙƒ Ø§Ù„Ø°ÙƒÙ, ...</li><li>.Ø§Ù„ØµÙ‚ Ù…Ø­ØªÙˆÙ‰ Ø§Ù„Ø­Ø§ÙØ¸Ø© ÙˆØ§Ø°Ù‡Ø¨</li></ol>",
    "modal.crios.ical.h": "Ø§ÙØªØ­ Safari",
    "modal.crios.ical.text":
      "Ù„Ø³ÙˆØ¡ Ø§Ù„Ø­Ø¸ ØŒ ÙÙˆØ§Ø¬Ù‡ Chrome Ø¹Ù„Ù‰ iOS Ù…Ø´Ø§ÙƒÙ„ ÙÙ Ø·Ø±ÙÙ‚Ø© Ø¥Ù†Ø´Ø§Ø¡ Ù…Ù„Ù Ø§Ù„ØªÙ‚ÙˆÙÙ…",
    "modal.crios.ical.steps":
    ...
    "modal.multidate.text":
      "Ø£Ø¶Ù Ø§Ù„Ø£Ø¬Ø²Ø§Ø¡ Ø§Ù„ÙØ±Ø¯ÙØ© ÙˆØ§Ø­Ø¯Ø© ØªÙ„Ùˆ Ø§Ù„Ø£Ø®Ø±Ù‰:",
    Event: "Ø­Ø¯Ø«",
    "Cancelled Date": "ØªÙ… Ø¥Ù„ØºØ§Ø¡ Ù‡Ø°Ø§ Ø§Ù„ØªØ§Ø±ÙØ®.",
    "Delete from Calendar":
      "Ø§Ù„Ø±Ø¬Ø§Ø¡ ØªØ­Ø¯ÙØ« Ø§Ù„ØªÙ‚ÙˆÙÙ… Ø§Ù„Ø®Ø§Øµ Ø¨Ùƒ!",
    "modal.subscribe.yahoo.h": "Ø£Ø¶Ù Ø§Ù„ØªÙ‚ÙˆÙÙ… Ø¥Ù„Ù‰ Yahoo",
    "modal.subscribe.yahoo.text":
      '<ol><li>Ø§ÙØªØ­ ØªÙ‚ÙˆÙÙ… Yahoo.</li><li>Ø§Ù†Ù‚Ø± ÙÙˆÙ‚ Ø¹Ù„Ø§Ù…Ø© Ø§Ù„ØªØ¨ÙˆÙØ¨ "Ø§Ù„Ø¥Ø¬Ø±Ø§Ø¡Ø§Øª".</li><li>Ø­Ø¯Ø¯ "Ù…ØªØ§Ø¨Ø¹Ø© ØªÙ‚ÙˆÙÙ…Ø§Øª Ø£Ø®Ø±Ù‰".</li><li>Ø§Ø®ØªØ± Ø§Ø³Ù…Ù‹Ø§ ÙˆØ§Ù„ØµÙ‚ Ø¹Ù†ÙˆØ§Ù† URL Ù…Ù† Ø§Ù„Ø­Ø§ÙØ¸Ø© Ø§Ù„Ø®Ø§ØµØ© Ø¨Ùƒ ÙÙ Ø­Ù‚Ù„ URL.</li></ol>',
    Cancel: "Ø¥Ø­Ø¨Ø§Ø·",
  },
  hi: {
    ...
    "modal.clipboard.text":
      "à¤¹à¤®à¤¨à¥‡ à¤†à¤ªà¤•à¥‡ à¤•à¥à¤²à¤¿à¤ªà¤¬à¥‹à¤°à¥à¤¡ à¤ªà¤° à¤¸à¥à¤µà¤à¤¾à¤²à¤¿à¤¤ à¤°à¥‚à¤ª à¤¸à¥‡ à¤à¤• à¤œà¤¾à¤¦à¥à¤ˆ URL à¤•à¥‰à¤ªà¥€ à¤•à¤° à¤²à¤¿à¤¯à¤¾ à¤¹à¥ˆà¥¤",
    "modal.webview.ical.steps":
      "<ol><li>à¤…à¤ªà¤¨à¥‡ à¤«à¤¼à¥‹à¤¨ à¤ªà¤° <strong>à¤¦à¥‚à¤¸à¤°à¤¾ à¤¬à¥à¤°à¤¾à¤‰à¤œà¤¼à¤° à¤–à¥‹à¤²à¥‡à¤‚</strong>, ...</li><li>à¤•à¥à¤²à¤¿à¤ªà¤¬à¥‹à¤°à¥à¤¡ à¤¸à¤¾à¤®à¤—à¥à¤°à¥€ <strong>à¤à¤¿à¤ªà¤•à¤¾à¤à¤‚</strong> à¤”à¤° à¤œà¤¾à¤à¤‚à¥¤</li></ol>",
    ...
    "modal.crios.ical.steps":
      "<ol><li><strong>à¤¸à¤«à¤¾à¤°à¥€ à¤–à¥‹à¤²à¥‡à¤‚</strong>, ...</li><li>à¤•à¥à¤²à¤¿à¤ªà¤¬à¥‹à¤°à¥à¤¡ à¤¸à¤¾à¤®à¤—à¥à¤°à¥€ <strong>à¤à¤¿à¤ªà¤•à¤¾à¤à¤‚</strong> à¤”à¤° à¤œà¤¾à¤à¤‚à¥¤</li></ol>",
    "modal.multidate.h":
    ...
    "modal.subscribe.yahoo.text":
      '<ol><li>Yahoo à¤•à¥ˆà¤²à¥‡à¤‚à¤¡à¤° à¤–à¥‹à¤²à¥‡à¤‚à¥¤</li><li>"à¤•à¥ƒà¤¤à¥€" à¤Ÿà¥ˆà¤¬ à¤ªà¤° à¤•à¥à¤²à¤¿à¤• à¤•à¤°à¥‡à¤‚à¥¤</li><li>"à¤‡à¤¤à¤° à¤•à¥…à¤²à¥‡à¤‚à¤¡à¤°à¥à¤¸à¤à¥‡ à¤…à¤¨à¥à¤¸à¤°à¤£ à¤•à¤°à¤¾" à¤à¥à¤¨à¥‡à¤‚à¥¤</li><li>à¤à¤• à¤¨à¤¾à¤® à¤à¥à¤¨à¥‡à¤‚ à¤”à¤° à¤…à¤ªà¤¨à¥‡ à¤•à¥à¤²à¤¿à¤ªà¤¬à¥‹à¤°à¥à¤¡ à¤¸à¥‡ URL à¤•à¥‹ URL à¤«à¤¼à¥€à¤²à¥à¤¡ à¤®à¥‡à¤‚ à¤ªà¥‡à¤¸à¥à¤Ÿ à¤•à¤°à¥‡à¤‚à¥¤</li></ol>',
  ...
  pl: {
    ...
    "modal.webview.ical.steps":
      "<ol><li><strong>OtwĂ³rz innÄ… przeglÄ…darkÄ™</strong> w swoim telefonie, ...</li><li><strong>Wklej</strong> zawartoÅ›Ä‡ schowka i ruszaj.</li></ol>",
    "modal.crios.ical.h": "OtwĂ³rz Safari",
    "modal.crios.ical.text":
      "Niestety, Chrome na iOS ma problemy ze sposobem generowania pliku kalendarza.",
    "modal.crios.ical.steps":
      "<ol><li><strong>OtwĂ³rz Safari</strong>, ...</li><li><strong>Wklej</strong> zawartoÅ›Ä‡ schowka i ruszaj.</li></ol>",
    ...
    "modal.subscribe.yahoo.text":
      '<ol><li>OtwĂ³rz kalendarz Yahoo.</li><li>Kliknij na zakÅ‚adkÄ™ "CzynnoÅ›ci".</li><li>Wybierz "Obserwuj inne kalendarze".</li><li>Wybierz nazwÄ™ i wklej adres URL ze schowka w polu URL.</li></ol>',
    Cancel: "Anuluj",
  },
  id: {
  ...
  no: {
    ...
    "modal.webview.ical.text":
      "Dessverre har nettlesere i appen problemer med mĂ¥ten vi genererer kalenderfilen pĂ¥.",
    "modal.clipboard.text":
      "Vi kopierte automatisk en magisk URL til utklippstavlen din.",
    "modal.webview.ical.steps":
      "<ol><li><strong>Ă…pne en annen nettleser</strong> pĂ¥ telefonen, ...</li><li><strong>Lim inn</strong> innholdet pĂ¥ utklippstavlen og gĂ¥.</li></ol>",
    "modal.crios.ical.h": "Ă…pne Safari",
    "modal.crios.ical.text":
      "Dessverre har Chrome pĂ¥ iOS problemer med mĂ¥ten vi genererer kalenderfilen pĂ¥.",
    "modal.crios.ical.steps":
      "<ol><li><strong>Ă…pne Safari</strong>, ...</li><li><strong>Lim inn</strong> innholdet pĂ¥ utklippstavlen og gĂ¥.</li></ol>",
    "modal.multidate.h": "Dette er en avtaleserie",
    "modal.multidate.text":
      "Legg til de enkelte datoene i kalenderen din i rekkefĂ¸lge:",
    Event: "MĂ¸te",
    ...
    "modal.subscribe.yahoo.text":
      "<ol><li>Ă…pne Yahoo-kalenderen.</li><li>Klikk pĂ¥ Â«HandlingerÂ»-fanen.</li><li>Velg Â«FĂ¸lg andre kalendereÂ».</li><li>Velg et navn og lim inn URL-en fra utklippstavlen i URL-feltet.</li></ol>",
    Cancel: "Avbryt",
  },
  fi: {
    ...
    "modal.webview.ical.text":
      "Valitettavasti sovelluksen sisĂ¤isillĂ¤ selaimilla on ongelmia kalenteritiedoston luomisessa.",
    "modal.clipboard.text":
      "Olemme automaattisesti kopioineet maagisen URL-osoitteen leikepĂ¶ydĂ¤llesi.",
    "modal.webview.ical.steps":
      "<ol><li><strong>Avaa toinen selain</strong> puhelimessasi., ...</li><li><strong>liitĂ¤</strong> leikepĂ¶ydĂ¤n sisĂ¤ltĂ¶ ja lĂ¤hde.</li></ol>",
    "modal.crios.ical.h": "Avaa Safari",
    "modal.crios.ical.text":
      "Valitettavasti iOS:n Chromessa on ongelmia kalenteritiedoston luomisessa.",
    "modal.crios.ical.steps":
      "<ol><li><strong>Avaa Safari</strong>, ...</li><li><strong>liitĂ¤</strong> leikepĂ¶ydĂ¤n sisĂ¤ltĂ¶ ja lĂ¤hde.</li></ol>",
    ...
    "modal.subscribe.yahoo.text":
      '<ol><li>Avaa Yahoo-kalenteri.</li><li>Napsauta "Toiminnot"-vĂ¤lilehteĂ¤.</li><li>Valitse "Seuraa muiden kalentereita".</li><li>Valitse nimi ja liitĂ¤ URL-osoite leikepĂ¶ydĂ¤ltĂ¤si URL-kenttĂ¤Ă¤n.</li></ol>',
    Cancel: "Peruuta",
  },
  sv: {
    ...
    "modal.webview.ical.text":
      "TyvĂ¤rr har webblĂ¤sare i appen problem med hur vi genererar kalenderfilen.",
    "modal.clipboard.text":
      "Vi har automatiskt kopierat en magisk URL till ditt klippblock.",
    "modal.webview.ical.steps":
      "<ol><li><strong>Ă–ppna en annan webblĂ¤sare</strong> pĂ¥ telefonen, ...</li><li><strong>InsĂ¤tt</strong> innehĂ¥llet i klippbordet och kĂ¶r.</li></ol>",
    "modal.crios.ical.h": "Ă–ppna Safari",
    "modal.crios.ical.text":
      "TyvĂ¤rr har Chrome pĂ¥ iOS problem med hur vi genererar kalenderfilen.",
    "modal.crios.ical.steps":
      "<ol><li><strong>Ă–ppna Safari</strong>, ...</li><li><strong>InsĂ¤tt</strong> innehĂ¥llet i klippbordet och kĂ¶r.</li></ol>",
    ...
    "modal.subscribe.yahoo.text":
      '<ol><li>Ă–ppna Yahoo-kalendern.</li><li>Klicka pĂ¥ fliken "Ă…tgĂ¤rder".</li><li>VĂ¤lj "FĂ¶lj andra kalendrar".</li><li>VĂ¤lj ett namn och klistra in URL:en frĂ¥n klippbordet i URL-fĂ¤ltet.</li></ol>',
    Cancel: "Avbryt",
  },
  cs: {
    ...
    "modal.webview.ical.text":
      "ProhlĂ­Å¾eÄe v aplikacĂ­ch majĂ­ bohuÅ¾el problĂ©my se zpÅ¯sobem generovĂ¡nĂ­ souboru kalendĂ¡Å™e.",
    "modal.clipboard.text":
      "Do schrĂ¡nky jsme automaticky zkopĂ­rovali kouzelnou adresu URL.",
    "modal.webview.ical.steps":
      "<ol><li><strong>OtevÅ™enĂ­ jinĂ©ho prohlĂ­Å¾eÄe</strong> v telefonu, ...</li><li><strong>VloÅ¾te</strong> obsah schrĂ¡nky a pÅ™ejdÄ›te.</li></ol>",
    "modal.crios.ical.h": "OtevÅ™Ă­t Safari",
    "modal.crios.ical.text":
      "Chrome v systĂ©mu iOS mĂ¡ bohuÅ¾el problĂ©my se zpÅ¯sobem generovĂ¡nĂ­ souboru kalendĂ¡Å™e.",
    "modal.crios.ical.steps":
      "<ol><li><strong>OtevÅ™Ă­t Safari</strong>, ...</li><li><strong>VloÅ¾te</strong> obsah schrĂ¡nky a pÅ™ejdÄ›te.</li></ol>",
    ...
    "modal.subscribe.yahoo.text":
      '<ol><li>OtevÅ™ete kalendĂ¡Å™ Yahoo.</li><li>KliknÄ›te na kartu "Akce".</li><li>Vyberte moÅ¾nost "Sledovat dalÅ¡Ă­ kalendĂ¡Å™e".</li><li>Vyberte nĂ¡zev a vloÅ¾te adresu URL ze schrĂ¡nky do pole URL.</li></ol>',
    Cancel: "Storno",
  },
  ja: {
    ...
    "modal.webview.ical.text":
      "æ®‹å¿µăªăŒă‚‰ă€ă‚¢ăƒ—ăƒªå†…ăƒ–ăƒ©ă‚¦ă‚¶ă¯ă€ă‚«ăƒ¬ăƒ³ăƒ€ăƒ¼ăƒ•ă‚¡ă‚¤ăƒ«ă®ç”Ÿæˆæ–¹æ³•ă«å•é¡ŒăŒă‚ă‚ă¾ă™ă€‚",
    "modal.clipboard.text":
      "é­”æ³•ă®URLă‚’è‡ªå‹•ç„ă«ă‚¯ăƒªăƒƒăƒ—ăƒœăƒ¼ăƒ‰ă«ă‚³ăƒ”ăƒ¼ă—ă¦ă„ă¾ă™ă€‚",
    "modal.webview.ical.steps":
      "<ol><li>ă‚¹ăƒăƒ¼ăƒˆăƒ•ă‚©ăƒ³ă§åˆ¥ă®ăƒ–ăƒ©ă‚¦ă‚¶ă‚’èµ·å‹•ă™ă‚‹, ...</li><li>ă‚¯ăƒªăƒƒăƒ—ăƒœăƒ¼ăƒ‰ă®å†…å®¹ă‚’è²¼ă‚ä»˜ă‘ă¦è¡Œăă€‚</li></ol>",
    "modal.crios.ical.h": "ă‚ªăƒ¼ăƒ—ăƒ³Safari",
    "modal.crios.ical.text":
      "æ®‹å¿µăªăŒă‚‰ă€iOSç‰ˆChromeă§ă¯ă€ă‚«ăƒ¬ăƒ³ăƒ€ăƒ¼ăƒ•ă‚¡ă‚¤ăƒ«ă®ç”Ÿæˆæ–¹æ³•ă«å•é¡ŒăŒă‚ă‚ă¾ă™ă€‚",
    "modal.crios.ical.steps":
      "<ol><li><strong>ă‚ªăƒ¼ăƒ—ăƒ³Safari</strong>, ...</li><li>ă‚¯ăƒªăƒƒăƒ—ăƒœăƒ¼ăƒ‰ă®å†…å®¹ă‚’è²¼ă‚ä»˜ă‘ă¦è¡Œăă€‚</li></ol>",
    ...
    "modal.subscribe.yahoo.text":
      "<ol><li>Yahooă‚«ăƒ¬ăƒ³ăƒ€ăƒ¼ă‚’é–‹ăă€‚</li><li>[å®Ÿè¡Œ] ă‚¿ăƒ–ă‚’ă‚¯ăƒªăƒƒă‚¯ă—ă¾ă™ă€‚</li><li>[ăă®ä»–ă®ă‚«ăƒ¬ăƒ³ăƒ€ăƒ¼ă®ăƒ•ă‚©ăƒ­ăƒ¼] ă‚’é¸æă—ă¾ă™ă€‚</li><li>åå‰ă‚’æ±ºă‚ă¦ă€ă‚¯ăƒªăƒƒăƒ—ăƒœăƒ¼ăƒ‰ă«ă‚ă‚‹URLă‚’URLæ¬„ă«è²¼ă‚ä»˜ă‘ă¾ă™ă€‚</li></ol>",
    Cancel: "ă‚­ăƒ£ăƒ³ă‚»ăƒ«",
  },
  it: {
  ...
  ko: {
    ...
    "modal.webview.ical.text":
      "ë¶ˆí–‰íˆë„ ́¸́•± ë¸Œë¼́°́ €ë” ́º˜ë¦°ë” íŒŒ́¼́„ ́ƒ́„±í•˜ë” ë°©́‹́— ë¬¸́ œê°€ ́ˆ́µë‹ˆë‹¤.",
    "modal.clipboard.text": "ë§¤́§ URĹ„ í´ë¦½ë³´ë“œ́— ́ë™́œ¼ë¡œ ë³µ́‚¬í–ˆ́µë‹ˆë‹¤.",
    "modal.webview.ical.steps":
      "<ol><li>íœ´ëŒ€́ „í™”́—́„œ ë‹¤ë¥¸ ë¸Œë¼́°́ € ́—´ê¸°, ...</li><li>í´ë¦½ë³´ë“œ ë‚´́©́„ ë¶™́—¬ë„£ê³  ́´ë™í•©ë‹ˆë‹¤.</li></ol>",
    "modal.crios.ical.h": "Safari ́—´ê¸°",
    "modal.crios.ical.text":
      "ë¶ˆí–‰íˆë„ iOŚ˜ Chromé€ ́º˜ë¦°ë” íŒŒ́¼́„ ́ƒ́„±í•˜ë” ë°©́‹́— ë¬¸́ œê°€ ́ˆ́µë‹ˆë‹¤.",
    "modal.crios.ical.steps":
      "<ol><li><strong>Safari ́—´ê¸°</strong>, ...</li><li>í´ë¦½ë³´ë“œ ë‚´́©́„ ë¶™́—¬ë„£ê³  ́´ë™í•©ë‹ˆë‹¤.</li></ol>",
    ...
    "modal.subscribe.yahoo.text":
      '<ol><li>Yahoo ́º˜ë¦°ë”ë¥¼ ́—½ë‹ˆë‹¤.</li><li>"ë™́‘" íƒ­́„ í´ë¦­í•©ë‹ˆë‹¤.</li><li>"ë‹¤ë¥¸ ́¼́ •ê´€ë¦¬ íŒ”ë¡œ́°"ë¥¼ ́„ íƒí•©ë‹ˆë‹¤.</li><li>́´ë¦„́„ ́„ íƒí•˜ê³  í´ë¦½ë³´ë“œ́˜ URĹ„ URL í•„ë“œ́— ë¶™́—¬ë„£́µë‹ˆë‹¤.</li></ol>',
    Cancel: "́·΅†Œ",
  },
  vi: {
    ...
    "modal.webview.ical.text":
      "Ráº¥t tiáº¿c, cĂ¡c trĂ¬nh duyá»‡t trong á»©ng dá»¥ng gáº·p sá»± cá»‘ vá»›i cĂ¡ch chĂºng tĂ´i táº¡o tá»‡p lá»‹ch.",
    "modal.clipboard.text":
      "ChĂºng tĂ´i Ä‘Ă£ tá»± Ä‘á»™ng sao chĂ©p má»™t URL ma thuáº­t vĂ o khay nhá»› táº¡m cá»§a báº¡n.",
    "modal.webview.ical.steps":
      "<ol><li><strong> Má»Ÿ trĂ¬nh duyá»‡t khĂ¡c </strong> trĂªn Ä‘iá»‡n thoáº¡i cá»§a báº¡n, ...</li><li><strong> DĂ¡n </strong> ná»™i dung khay nhá»› táº¡m vĂ  báº¯t Ä‘áº§u.</li></ol>",
    "modal.crios.ical.h": "Má»Ÿ Safari",
    "modal.crios.ical.text":
      "Ráº¥t tiáº¿c, Chrome trĂªn iOS gáº·p sá»± cá»‘ vá»›i cĂ¡ch chĂºng tĂ´i táº¡o tá»‡p lá»‹ch.",
    "modal.crios.ical.steps":
      "<ol><li><strong>Má»Ÿ Safari</strong>, ...</li><li><strong> DĂ¡n </strong> ná»™i dung khay nhá»› táº¡m vĂ  báº¯t Ä‘áº§u.</li></ol>",
    ...
    "modal.subscribe.yahoo.text":
      '<ol><li>Má»Ÿ Lá»‹ch Yahoo.</li><li>Nháº¥p vĂ o tab "HĂ nh Ä‘á»™ng".</li><li>Chá»n "Theo dĂµi cĂ¡c Lá»‹ch khĂ¡c".</li><li>Chá»n tĂªn vĂ  dĂ¡n URL tá»« khay nhá»› táº¡m cá»§a báº¡n vĂ o trÆ°á»ng URL.</li></ol>',
    Cancel: "Há»§y bá»",
  },
};
